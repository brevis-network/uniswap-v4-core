...
import {IZkRebate} from "./IZkRebate.sol";

contract MySwapRouter is PoolTestBase {
    ...
    function claim(IZkRebate zk,
        address receiver, // uni will be sent to this address
        bytes calldata _proof,
        bytes[] calldata _appCircuitOutputs,
        bytes32[] calldata _proofIds,
        IZkRebate.ProofData[] calldata _proofDataArray) external{
            zk.claimWithZkProof(
                receiver,
                _proof,
                _appCircuitOutputs,
